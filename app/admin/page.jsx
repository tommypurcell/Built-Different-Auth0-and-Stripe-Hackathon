...
export default function AdminPage() {
  ...
  const [apiConfig, setApiConfig] = useState(() => {
    ...
    try {
      return { ...getDefaultApiConfig(), ...JSON.parse(stored) };
    } catch {
    ...
    <div className="mx-auto flex max-w-content flex-col gap-8 px-6 py-10 md:py-14">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <div className="mt-4 grid gap-4 md:grid-cols-[0.7fr_0.7fr_1fr_auto]">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Textarea
                          ...
                          rows={3}
                          className="rounded-[20px] border-neutral-200 bg-neutral-50"
                        />
                      </div>
        ...
        <section className="flex flex-col gap-6">
          <div className="rounded-[28px] border border-white/70 bg-neutral-950 p-6 text-white shadow-[0_18px_55px_-44px_rgba(22,34,49,0.35)]">
